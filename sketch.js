...
function setup() {
  ...
  mango2=new mango(1170,130,30);
	...
	launcherObject=new launcher(stoneObj.body,{x:235,y:390})
...
function draw() {
  ...
  background(52,161,211);
  //frameRate(2)
 // Engine.update(engine)
  textSize(25);
  text("Press Space to Eat An Another Mango ?",50 ,50);
  image(boy ,205,285,200,300);
  //Engine.update(engine)
